      ...
      <div className="w-full h-[200px] bg-primary font-primary relative">
        ...
        >
          ...
          <div className="w-full h-full py-10 px-10 flex flex-col gap-2 ">
            <p className="text-white font-semibold font-primary text-2xl lg:text-3xl w-3/4 lg:w-1/2 z-20">
        ...
        <div className="w-[90%] md:w-[80%] lg:w-[60%] h-1/2 flex  justify-between items-center mx-auto absolute bottom-5 left-[50%] translate-x-[-50%]">
